...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: 
    // - Enqueue is adding all people to the first index (overwriting previous people)
    ...
    // Defect(s) Found: None at this point (running tests 1 at a time)
    ...
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: 
    // -GetNextPerson is not enqueuing persons with infinite turns
